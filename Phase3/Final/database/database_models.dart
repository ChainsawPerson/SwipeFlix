...
class LikedList {
  ...
  final String title_title_primaryTitle;
  final String like_timestamp;

  const LikedList({
    required this.title_title_id,
    required this.title_title_primaryTitle,
  ...
  factory LikedList.fromJson(Map<String, dynamic> json) => LikedList(
      ...
      title_title_primaryTitle: json['title_title_primaryTitle'],
      like_timestamp: json['like_timestamp']);

  Map<String, dynamic> toJson() => {
        'title_title_id': title_title_id,
        'title_title_primaryTitle': title_title_primaryTitle,
...
class DislikedList {
  final int title_title_id;
  final int title_title_primaryTitle;
